...
export default function Nav() {
  return <nav className="sticky top-0 w-full grid grid-cols-2 grid-rows-1 px-4 py-2 justify-between align-middle bg-black/50 backdrop-blur-md z-50">
    ...
    <div className="w-100 flex flex-row justify-center items-center gap-4">
      ...
      <a href="mailto:mail@tutanota.com" className="rounded-xl bg-yellow-400 text-gray-700 hover:bg-yellow-300 active:text-gray-100 active:bg-yellow-500 duration-150 transition-all text-lg font-semibold px-5 py-1">Contact me</a>
    </div>
  </nav>
}
